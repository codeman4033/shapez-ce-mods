...
declare module "shapez/translations" {
     ...
     * @param {string | ""} region
     */
    export function loadTranslationData(code: string, region: string | ""): Promise<any>;
...
declare module "shapez/core/singleton_factory" {
    export class SingletonFactory<T extends {
        getId(): string;
    }> {
        id: string;
        entries: T[];
...
declare module "shapez/savegame/serialization_data_types" {
    ...
    export class TypePositiveInteger extends BaseDataType {
        ...
        verifySerializedValue(value: any): "Not a valid number" | "Negative value for positive integer";
    }
    ...
    export class TypeTileVector extends BaseDataType {
        ...
        verifySerializedValue(value: any): "Not a valid tile vector, missing x/y or bad data type" | "Invalid tile vector, x or y < 0";
    }
    ...
    export class TypeClassId extends BaseDataType {
        ...
        registry: import("shapez/core/factory").Factory<any> | import("shapez/core/singleton_factory").SingletonFactory<any>;
        serialize(value: any): string;
        getAsJsonSchemaUncached(): {
            type: string;
            enum: string[];
     ...
     * <T>
     */
    export type SingletonFactoryTemplate<T extends {
        getId(): string;
...
declare module "shapez/core/input_receiver" {
    ...
    export type ReceiverId = keyof {
        [K in keyof InputReceiver as InputReceiver[K] extends Signal<any[]> ? K extends "destroyed" ? never : K : never]: unknown;
    };
}
...
declare module "shapez/game/hud/base_hud_part" {
    export class BaseHUDPart {
         ...
         *
         */
        trackClicks(element: Element, handler: import("shapez/core/signal").SignalReceiver<[]>, args?: import("shapez/core/click_detector").ClickDetectorConstructorArgs | undefined): void;
        /**
...
declare module "shapez/core/game_state" {
    ...
    export class GameState {
         ...
         */
        internalRegisterCallback(stateManager: StateManager, app: Application): void;
        /**
...
declare module "shapez/game/components/static_map_entity" {
    export class StaticMapEntityComponent extends Component {
         ...
         */
        drawSpriteOnBoundsClipped(parameters: DrawParameters, sprite: AtlasSprite, extrudePixels?: number | undefined, overridePosition?: Vector | undefined, pixelAligned?: boolean | undefined): void;
    }
    import { Component } from "shapez/game/component";
    import { Vector } from "shapez/core/vector";
    import { AtlasSprite } from "shapez/core/sprites";
...
declare module "shapez/game/shape_definition" {
    ...
    export class ShapeDefinition extends BasicSerializableObject {
        ...
        /** @type {string} */
        cachedHash: string;
        bufferGenerator: (canvas: HTMLCanvasElement, context: CanvasRenderingContext2D, w: number, h: number, dpi: number) => void;
        /**
...
declare module "shapez/game/item_resolver" {
     ...
     */
    export function itemResolverSingleton(root: import("shapez/savegame/savegame_serializer").GameRoot, data: {
        $: string;
        data: any;
    }): any;
...
declare module "shapez/core/draw_utils" {
     ...
     * Whether to round the canvas coordinates, to avoid issues with transparency between tiling images
     */
    export function drawSpriteClipped({ parameters, sprite, x, y, w, h, originalW, originalH, pixelAligned, }: {
        parameters: DrawParameters;
...
declare module "shapez/game/buildings/wire" {
    ...
    export class MetaWireBuilding extends MetaBuilding {
         ...
         */
        getPreviewSprite(rotationVariant: number, variant: string): import("shapez/core/draw_utils").AtlasSprite;
        getBlueprintSprite(rotationVariant: any, variant: any): import("shapez/core/sprites").AtlasSprite;
        /**
         * Should compute the optimal rotation variant on the given tile
         * @param {object} param0
         * @param {GameRoot} param0.root
...
declare module "shapez/game/systems/wire" {
    ...
    export class WireSystem extends GameSystem {
         ...
         */
        findNetworkForEjector(initialEntity: Entity, slot: import("shapez/game/components/wired_pins").WirePinSlot): void;
        /**
...
declare module "shapez/game/game_mode" {
    ...
    export class GameMode extends BasicSerializableObject {
         ...
         */
        static create(root: GameRoot, id?: string, payload?: object | undefined): GameMode;
        /**
         * @param {GameRoot} root
         */
        constructor(root: GameRoot);
...
declare module "shapez/game/buildings/belt" {
    ...
    export class MetaBeltBuilding extends MetaBuilding {
        ...
        getSprite(): any;
        getIsReplaceable(): boolean;
        getPreviewSprite(rotationVariant: any): import("shapez/core/sprites").AtlasSprite;
        getBlueprintSprite(rotationVariant: any): import("shapez/core/sprites").AtlasSprite;
        /**
         * Creates the entity at the given location
         * @param {Entity} entity
         */
...
declare module "shapez/game/systems/underground_belt" {
    export class UndergroundBeltSystem extends GameSystemWithFilter {
         ...
         */
        findReceiverForSender(entity: Entity): import("shapez/game/components/underground_belt").LinkedUndergroundBelt;
        /**
         *
         * @param {Entity} entity
         */
...
declare module "shapez/game/systems/belt_underlays" {
    export class BeltUnderlaysSystem extends GameSystem {
         ...
         */
        computeBeltUnderlayType(entity: Entity, underlayTile: import("shapez/game/components/belt_underlays").BeltUnderlayTile): enumClippedBeltUnderlayType;
        /**
         * Draws a given chunk
         * @param {DrawParameters} parameters
         * @param {MapChunkView} chunk
...
declare module "shapez/game/systems/logic_gate" {
    export class LogicGateSystem extends GameSystemWithFilter {
        ...
        boundOperations: {
            ...
            [enumLogicGateType.transistor]: (parameters: Array<BaseItem | null>) => BaseItem;
            [enumLogicGateType.rotator]: (parameters: Array<BaseItem | null>) => BaseItem;
            [enumLogicGateType.analyzer]: (parameters: Array<BaseItem | null>) => [BaseItem, BaseItem];
            [enumLogicGateType.cutter]: (parameters: Array<BaseItem | null>) => [BaseItem, BaseItem];
            [enumLogicGateType.unstacker]: (parameters: Array<BaseItem | null>) => [BaseItem, BaseItem];
            [enumLogicGateType.compare]: (parameters: Array<BaseItem | null>) => BaseItem;
            [enumLogicGateType.stacker]: (parameters: Array<BaseItem | null>) => BaseItem;
            [enumLogicGateType.painter]: (parameters: Array<BaseItem | null>) => BaseItem;
        };
        /**
...
declare module "shapez/game/systems/display" {
    ...
    export class DisplaySystem extends GameSystem {
         ...
         * @param {MapChunkView} chunk
         */
        drawChunk(parameters: import("shapez/core/draw_utils").DrawParameters, chunk: MapChunkView): BaseItem;
    }
    import { BaseItem } from "shapez/game/base_item";
    import { GameSystem } from "shapez/game/game_system";
    import { MapChunkView } from "shapez/game/map_chunk_view";
...
declare module "shapez/game/systems/item_processor_overlays" {
    export class ItemProcessorOverlaysSystem extends GameSystem {
         ...
         */
        drawConnectedSlotRequirement(parameters: import("shapez/core/draw_utils").DrawParameters, entity: Entity, { drawIfFalse }: {
...
declare module "shapez/game/systems/zone" {
    export class ZoneSystem extends GameSystem {
         ...
         * @returns
         */
        prePlacementCheck(entity: Entity, tile?: Vector | undefined): "stop_propagation";
        /**
         * Draws the zone
         * @param {DrawParameters} parameters
         * @param {MapChunkView} chunk
...
declare module "shapez/core/tracked_state" {
    ...
    export class TrackedState<T> {
        ...
        constructor(callbackMethod?: TrackedStateCallback<T>, callbackScope?: unknown);
        set(value: T, changeHandler?: TrackedStateCallback<T>, changeScope?: unknown): void;
...
declare module "shapez/game/buildings/underground_belt" {
    ...
    export class MetaUndergroundBeltBuilding extends MetaBuilding {
         ...
         * @param {string} variant
         */
        getPreviewSprite(rotationVariant: number, variant: string): import("shapez/core/sprites").AtlasSprite;
        /**
         * @param {number} rotationVariant
         * @param {string} variant
         */
        getBlueprintSprite(rotationVariant: number, variant: string): import("shapez/core/sprites").AtlasSprite;
        /**
         * Creates the entity at the given location
         * @param {Entity} entity
         */
...
declare module "shapez/core/modal_dialog_elements" {
    import type { Application } from "shapez/application";
    import { ClickDetector, ClickDetectorConstructorArgs } from "shapez/core/click_detector";
...
declare module "shapez/game/hud/parts/modal_dialogs" {
    export class HUDModalDialogs extends BaseHUDPart {
         ...
         */
        showInfo(title: string, text: string, buttons?: Array<`${string}:${string}`>): Record<string, import("shapez/core/signal").Signal<[]>>;
        /**
         * @param {string} title
         * @param {string} text
         * @param {Array<import("shapez/../../../core/modal_dialog_elements").DialogButtonStr<string>>} buttons
         */
        showWarning(title: string, text: string, buttons?: Array<import("shapez/core/modal_dialog_elements").DialogButtonStr<string>>): Record<string, import("shapez/core/signal").Signal<[]>>;
        showOptionChooser(title: any, options: any): Record<"optionSelected", import("shapez/core/signal").Signal<[] | [string]>>;
...
declare module "shapez/game/hud/parts/shape_tooltip" {
    export class HUDShapeTooltip extends BaseHUDPart {
        ...
        isPlacingBuilding: boolean | import("shapez/game/meta_building").MetaBuilding;
        isActive(): boolean;
    }
    import { BaseHUDPart } from "shapez/game/hud/base_hud_part";
    import { Vector } from "shapez/core/vector";
...
declare module "shapez/game/hud/parts/layer_preview" {
    ...
    export class HUDLayerPreview extends BaseHUDPart {
         ...
         * @param {number} scale 1 / zoomLevel
         */
        renderPreview(parameters: import("shapez/core/draw_utils").DrawParameters, worldPos: Vector, scale: number): void;
    }
    import { BaseHUDPart } from "shapez/game/hud/base_hud_part";
    import { Vector } from "shapez/core/vector";
}
...
declare module "shapez/game/buildings/logic_gate" {
    ...
    export class MetaLogicGateBuilding extends MetaBuilding {
        ...
        getLayer(): "wires";
        getDimensions(): Vector;
        getSpecialOverlayRenderMatrix(rotation: any, rotationVariant: any, variant: any): number[];
        getAvailableVariants(): string[];
        /**
         *
         * @param {Entity} entity
...
declare module "shapez/savegame/puzzle_serializer" {
    export class PuzzleSerializer {
         ...
         */
        deserializePuzzle(root: GameRoot, puzzle: import("shapez/savegame/savegame_typedefs").PuzzleGameData): string;
    }
    import { GameRoot } from "shapez/game/root";
    import { BaseItem } from "shapez/game/base_item";
}
...
declare module "shapez/game/hud/parts/wire_info" {
    export class HUDWireInfo extends BaseHUDPart {
         ...
         * @param {WireNetwork} network
         */
        drawHighlightedNetwork(parameters: import("shapez/core/draw_utils").DrawParameters, network: WireNetwork): void;
    }
    import { BaseHUDPart } from "shapez/game/hud/base_hud_part";
...
declare module "shapez/game/core" {
    ...
    export class GameCore {
         ...
         */
        initializeRoot(parentState: import("shapez/states/ingame").InGameState, savegame: Savegame, gameModeId: any): void;
        /**
...
declare module "shapez/mods/mod_signals" {
    export namespace MOD_SIGNALS {
        ...
        let gameSerialized: Signal<[GameRoot, import("shapez/savegame/savegame_typedefs").SerializedGame]>;
        let gameDeserialized: Signal<[GameRoot, import("shapez/savegame/savegame_typedefs").SerializedGame]>;
    }
    import { Signal } from "shapez/core/signal";
    import { BaseHUDPart } from "shapez/game/hud/base_hud_part";
    import { GameRoot } from "shapez/game/root";
...
declare module "shapez/savegame/serialization" {
     ...
     */
    export function deserializeSchema(obj: object, schema: Schema, data: object, baseclassErrorResult?: (string | void | null) | undefined, root?: import("shapez/game/root").GameRoot | undefined): string | void;
    /**
    ...
    export namespace types {
         ...
         * @param {FactoryTemplate<*>|SingletonFactoryTemplate<*>} registry
         */
        export function classId(registry: FactoryTemplate<any> | SingletonFactoryTemplate<any>): TypeClassId;
        /**
         * @param {BaseDataType} valueType
         * @param {boolean=} includeEmptyValues
         */
        export function keyValueMap(valueType: BaseDataType, includeEmptyValues?: boolean | undefined): TypeKeyValueMap;
        /**
         ...
         */
        export function obj(registry: FactoryTemplate<any>, resolver?: ((GameRoot: any, any: any) => object) | undefined): TypeClass;
        /**
         * @param {FactoryTemplate<*>} registry
         */
         ...
         * @param {SingletonFactoryTemplate<*>} registry
         */
        export function classRef(registry: SingletonFactoryTemplate<any>): TypeMetaClass;
        /**
         * @param {Object.<string, BaseDataType>} descriptor
         */
...
declare module "shapez/mods/mod_interface" {
    ...
    export class ModInterface {
         ...
         */
        replaceMethod<C extends constructable, P extends C["prototype"], M extends keyof P, O extends extendsPrams<P[M]>>(classHandle: C, methodName: M, override: bindThis<beforePrams<O, P[M]>, InstanceType<C>>): void;
        /**
         ...
         */
        runBeforeMethod<C extends constructable, P extends C["prototype"], M extends keyof P, O extends extendsPrams<P[M]>>(classHandle: C, methodName: M, executeBefore: bindThis<O, InstanceType<C>>): void;
        /**
         ...
         */
        runAfterMethod<C extends constructable, P extends C["prototype"], M extends keyof P, O extends extendsPrams<P[M]>>(classHandle: C, methodName: M, executeAfter: bindThis<O, InstanceType<C>>): void;
        /**
         *
         * @param {Object} prototype
         * @param {({ $super, $old }) => any} extender
         */
        extendObject(prototype: any, extender: ({ $super, $old }: any) => any): void;
        /**
         *
         * @param {Class} classHandle
         * @param {({ $super, $old }) => any} extender
         */
        extendClass(classHandle: Class, extender: ({ $super, $old }: any) => any): void;
        /**
         *
         * @param {string} id
        ...
        addVariantToExistingBuilding(metaClass: new () => MetaBuilding, variant: string, payload: {
            ...
            additionalStatistics?: ((root: GameRoot) => [string, string][]) | undefined;
...
declare module "shapez/mods/mod" {
    ...
    export abstract class Mod {
        ...
        protected readonly signals: {
            ...
            hudElementInitialized: import("shapez/core/signal").Signal<[import("shapez/game/hud/base_hud_part").BaseHUDPart]>;
            hudElementFinalized: import("shapez/core/signal").Signal<[import("shapez/game/hud/base_hud_part").BaseHUDPart]>;
            hudInitializer: import("shapez/core/signal").Signal<[import("shapez/game/root").GameRoot]>;
            gameInitialized: import("shapez/core/signal").Signal<[import("shapez/game/root").GameRoot]>;
            gameLoadingStageEntered: import("shapez/core/signal").Signal<[import("shapez/states/ingame").InGameState, string]>;
            gameStarted: import("shapez/core/signal").Signal<[import("shapez/game/root").GameRoot]>;
            stateEntered: import("shapez/core/signal").Signal<[import("shapez/core/game_state").GameState]>;
            gameSerialized: import("shapez/core/signal").Signal<[import("shapez/game/root").GameRoot, import("shapez/savegame/savegame_typedefs").SerializedGame]>;
            gameDeserialized: import("shapez/core/signal").Signal<[import("shapez/game/root").GameRoot, import("shapez/savegame/savegame_typedefs").SerializedGame]>;
        };
        readonly id: string;
...
declare module "shapez/savegame/schemas/1008" {
    export class SavegameInterface_V1008 extends SavegameInterface_V1007 {
         ...
         * @param {import("shapez/../savegame_typedefs.js").SavegameData} data
         */
        static migrate1007to1008(data: import("shapez/savegame/savegame_typedefs").SavegameData): void;
    }
...
declare module "shapez/core/input_distributor" {
    ...
    export class InputDistributor {
        ...
        bindToEvents(): void;
        forwardToReceiver<T extends ReceiverId>(eventId: T, payload?: Parameters<InputReceiver[T]["dispatch"]>[0]): void | "stop_propagation";
        ...
        handleKeyMouseDown(event: KeyboardEvent | MouseEvent): void | "stop_propagation";
...
declare module "shapez/platform/api" {
    export class ClientAPI {
         ...
         */
        apiListPuzzles(category: "new" | "top-rated" | "mine"): Promise<import("shapez/savegame/savegame_typedefs").PuzzleMetadata[]>;
        /**
         ...
         */
        apiDownloadPuzzle(puzzleId: number): Promise<import("shapez/savegame/savegame_typedefs").PuzzleFullData>;
        /**
         * @param {number} puzzleId
         * @returns {Promise<import("shapez/../savegame/savegame_typedefs").PuzzleFullData>}
         */
        apiDeletePuzzle(puzzleId: number): Promise<import("shapez/savegame/savegame_typedefs").PuzzleFullData>;
        /**
         * @param {string} shortKey
         * @returns {Promise<import("shapez/../savegame/savegame_typedefs").PuzzleFullData>}
         */
        apiDownloadPuzzleByKey(shortKey: string): Promise<import("shapez/savegame/savegame_typedefs").PuzzleFullData>;
        /**
         * @param {number} puzzleId
         * @returns {Promise<void>}
         */
...
declare module "shapez/states/puzzle_menu" {
    export class PuzzleMenuState extends TextualGameState {
         ...
         * @returns {Promise<import("shapez/../savegame/savegame_typedefs").PuzzleMetadata[]>}
         */
        getPuzzlesForCategory(category: any): Promise<import("shapez/savegame/savegame_typedefs").PuzzleMetadata[]>;
        /**
         *
         * @param {number} puzzleId
         ...
         * @param {Array<number>=} nextPuzzles
         */
        startLoadedPuzzle(puzzle: import("shapez/savegame/savegame_typedefs").PuzzleFullData, nextPuzzles?: Array<number> | undefined): void;
        onEnter(payload: any): void;
        loadPuzzle(): void;
...
declare module "shapez/game/modes/puzzle_edit" {
    export class PuzzleEditGameMode extends PuzzleGameMode {
        static getSchema(): {};
        hiddenBuildings: (typeof MetaItemProducerBuilding | typeof MetaLeverBuilding | typeof MetaVirtualProcessorBuilding)[];
    }
    import { PuzzleGameMode } from "shapez/game/modes/puzzle";
